...
class ComputeAutocorrelograms(mlpr.Processor):
    ...
    def run(self):
        ...
        logger.info('ComputeAutocorrelograms 1')
        ...
        logger.info('ComputeAutocorrelograms 2')
...
class Autocorrelograms:
    ...
    def javascript_state_changed(self, prev_state, state):
        logger.info('Autocorrelograms 1')
        ...
        logger.info('Autocorrelograms 2')
        ...
        logger.info('Autocorrelograms 3')
        ...
        logger.info('Autocorrelograms 4')
